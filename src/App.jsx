...
<th className="pl-6 pr-0 py-3 text-left text-xs font-semibold text-gray-700">Sr. No</th>
<th className="pl-0 pr-0 py-3 text-left text-xs font-semibold text-gray-700">User name</th>
...
<td className="pl-6 pr-2 py-4 text-sm text-gray-900">{index + 1}</td>
